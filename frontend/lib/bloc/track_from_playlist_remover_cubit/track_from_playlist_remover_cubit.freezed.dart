...
/// @nodoc
mixin _$TrackFromPlaylistRemoverState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TrackFromPlaylistRemoverState);
}
...
@override
String toString() {
  return 'TrackFromPlaylistRemoverState()';
}
...
/// @nodoc
class $TrackFromPlaylistRemoverStateCopyWith<$Res>  {
$TrackFromPlaylistRemoverStateCopyWith(TrackFromPlaylistRemoverState _, $Res Function(TrackFromPlaylistRemoverState) __);
}


/// Adds pattern-matching-related methods to [TrackFromPlaylistRemoverState].
extension TrackFromPlaylistRemoverStatePatterns on TrackFromPlaylistRemoverState {
...
class _Initial implements TrackFromPlaylistRemoverState {
  const _Initial();
...
@override
String toString() {
  return 'TrackFromPlaylistRemoverState.initial()';
}
...
class _LoadInProgress implements TrackFromPlaylistRemoverState {
...
@override
String toString() {
  return 'TrackFromPlaylistRemoverState.loadInProgress()';
}
...
class _Success implements TrackFromPlaylistRemoverState {
  const _Success();
...
@override
String toString() {
  return 'TrackFromPlaylistRemoverState.success()';
}
...
class _Error implements TrackFromPlaylistRemoverState {
  const _Error();
...
@override
String toString() {
  return 'TrackFromPlaylistRemoverState.error()';
}
