...
class Playlist extends Equatable {
  ...
  const Playlist({required this.id, required this.title, this.image, required this.tracks});
  ...
  Playlist copyWith({String? title, String? image, List<Track>? tracks}) {
    return Playlist(id: id, title: title ?? this.title, image: image ?? this.image, tracks: tracks ?? this.tracks);
  }
