...
class _RestClient implements RestClient {
  ...
  Future<VideoInfo?> fetchYtVideoInfo(String url) async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>?>(_setStreamType<VideoInfo>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value =
        _result.data == null ? null : VideoInfo.fromJson(_result.data!);
    return value;
  }
  ...
  Future<List<Artist>> getAllArtists() async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<Artist>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<Artist> getArtist(String id) async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<Artist>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
